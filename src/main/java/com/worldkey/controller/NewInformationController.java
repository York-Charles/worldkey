...
//		 String result = sb.toString();
	...
	@RequestMapping("compileto")
	 @ResponseBody
	 public ResultUtil compileto(Long id,String title,String titleImg,String info1,@RequestHeader("host") String host){
		 InformationAll informationa = informationAllMapper.selectByPrimaryKey1(id);
		 SimpleDateFormat format = new SimpleDateFormat("yyyyMMdd");
	     String dir = format.format(new Date());
		 String info2 = info1.replace("/storage/emulated/0/Android/data/life.dubai.com.mylife/files/", "http://"+host+"/image/"+dir+"/");
