...
public class PraiseController {
	...
	public ResultUtil addCommentPraise(String token, Integer commentId) throws Exception  {
		...
		h.setToUserId(comment1.getUsers().getId());
		h.setToHeadImg(comment1.getUsers().getHeadImg());
...
//			throw new Z406Exception("无点赞记录");
			return new ResultUtil(200, "no", "无点赞记录");
		}
