...
public class History {
	...
	public History(Integer id, String groupName, Long userId, String userName, String groupImg,
			...
			Integer classify, String headImg, String title, String titleImg, String webUrl,Integer groupId,String commentInfo,Integer toCommentId,String aCommentInfo,Long toUserId,String toHeadImg) {
		super();
		this.id = id;
