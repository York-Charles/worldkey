...
public interface InformationAllMapper {
    ...
    List<InformationAll> selectByType(@Param("type")Integer type,@Param("checked")Integer checked,@Param("title")String title);
...
//    @ResultMap(value = "com.worldkey.mapper.InformationAllMapper.BaseShowResultMap")
    ...
    @Select("select * from information_all where id=#{id}")
