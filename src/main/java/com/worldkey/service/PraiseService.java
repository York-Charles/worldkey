...
public interface PraiseService {
	...
	/*
	 * Praise selectByPrimaryKey(Long praiseId); Integer delete(Praise
	 * record)throws Exception; int selectByPrimaryKeySelective(Long praiseId,
	 * Integer information) ; int deleteByPrimaryKey(Long praiseId, Integer
	 * information); Integer insert(Praise record) throws Exception;
	 */
