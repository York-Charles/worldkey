    ...
    <div class="row">
        <div class="col-sm-2">
            ...
            <shiro:hasRole name="usersManage">
               ...
               <a class="btn btn-default btn-block" href="show/manageList?oneType=36" target="new">精选</a>
               <a class="btn btn-default btn-block" href="ShortVideo/video" target="new">视频</a>
               <a class="btn btn-default btn-block" href="ShortVideo/videoRecycle" target="new">视频回收站</a>
